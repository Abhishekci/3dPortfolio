...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-auto flex-row items-start gap-5`}>
        <div className="flex flex-col justify-center items-center mt-5">
          ...
          <div>
            ...
            <p className={`${styles.heroSubText} mt-2 text-white-100`}>
               A passionate full-stack developer with a keen interest in AI, ML, and Web3.
            </p>
          </div>
      </div>
          <ComputersCanvas/>
